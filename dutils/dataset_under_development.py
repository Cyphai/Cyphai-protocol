# Simple datasets designed for cyphai contracts
...
class Dataset(object):
    ...
    def cyphai_init(self, training_partition=None, testing_partition=None):
        # Initialize all of the cyphai stuff with partition info
